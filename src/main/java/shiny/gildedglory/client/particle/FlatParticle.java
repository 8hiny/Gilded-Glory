...
public class FlatParticle extends SpriteBillboardParticle {
    ...
    public FlatParticle(ClientWorld world, double x, double y, double z, double velX, double velY, double velZ, float angle, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new FlatParticle(clientWorld, d, e, f, g, h, i, 1.0f, this.spriteProvider);
        }

        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, float angle) {
            return new FlatParticle(clientWorld, d, e, f, g, h, i, angle, this.spriteProvider);
        }
    }
}
