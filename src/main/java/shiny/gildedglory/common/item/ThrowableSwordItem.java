...
public class ThrowableSwordItem extends SwordItem implements CustomAttackWeapon, CustomEffectsWeapon, ChargeableWeapon {
    ...
    public void spawnIraedeus(World world, PlayerEntity user, ItemStack stack) {
        if (!world.isClient()) {
            ...
            ThrowableSwordComponent component = ModComponents.THROWABLE_WIP.get(user);
            ...
            ThrowableSwordEntity iraedeus = new ThrowableSwordEntity(world, user, slot, pos.x, pos.y, pos.z);
    ...
    public AttackContext onAttack(ItemStack stack, LivingEntity attacker, Entity target, DamageSource source, float amount, boolean critical, boolean sweeping) {
        ...
        if (!attacker.getWorld().isClient()) {
            ...
            ThrowableSwordItem.setCooldown(stack, 80);
        }
