...
public class oldForgeWeldingRecipe implements Recipe<RecipeInputInventory> {
    ...
    public oldForgeWeldingRecipe(Identifier id, DefaultedList<Ingredient> input, ItemStack output) {
        this.id = id;
        this.output = output;
        this.input = input;
    }
    ...
    public static class Serializer implements RecipeSerializer<oldForgeWeldingRecipe> {

        public oldForgeWeldingRecipe read(Identifier identifier, JsonObject jsonObject) {
            ...
            if (defaultedList.isEmpty()) {
                ...
                return new oldForgeWeldingRecipe(identifier, defaultedList, itemStack);
            }
        }
        ...
        public oldForgeWeldingRecipe read(Identifier identifier, PacketByteBuf packetByteBuf) {
        ...
        public void write(PacketByteBuf packetByteBuf, oldForgeWeldingRecipe recipe) {
