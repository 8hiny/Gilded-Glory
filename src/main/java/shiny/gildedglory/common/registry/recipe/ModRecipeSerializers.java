...
public interface ModRecipeSerializers<T extends Recipe<?>> extends RecipeSerializer<T> {

    RecipeSerializer<ForgeWeldingRecipe> FORGE_WELDING = register("forge_welding", new ForgeWeldingRecipe.Serializer());
